...
<body>
    ...
    <!-- Daftar Cabin -->
     <div class="container mt-5" id="cabin">
        <h3 class="mb-4">Daftar Cabin</h3>
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="image-hover">
                        <img src="{{ asset('assets/Cabin1.1.jpg') }}" class="card-img-top img-first">
                        <img src="{{ asset('assets/Cabin1.2.jpg') }}" class="card-img-top img-second">
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Cabin Riverside </h5>
                        <p class="card-text">Tipe: A-Frame Riverside Cabin</p>
                        <p class="card-text">Harga: Rp. 1.429.000/Malam</p>                        
                        <p class="card-text">Kapasitas: 2 orang</p>                                                
                        <p class="card-text">Unit tersedia: <span class="stok">5</span> kamar</p>
                        <div class="btn-group-custom">                            
                            <button class="btn btn-detail w-100 mb-2">Detail</button>

                            <div class="d-flex gap-2">
                                <button class="btn btn-success btn-booking">Booking</button>
                                <button class="btn btn-outline-warning btn-wishlist">⭐ Wishlist</button>
                            </div>                            
                        </div>  
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="image-hover">
                        <img src="{{ asset('assets/cabin2.1.jpg') }}" class="card-img-top img-first">
                        <img src="{{ asset('assets/Cabin2.2.jpg') }}" class="card-img-top img-second">
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Cabin Mountain View</h5>
                        <p class="card-text">Tipe: Loft Family Cabin</p>
                        <p class="card-text">Harga: Rp. 1.800.000/Malam</p>
                        <p class="card-text">Kapasitas: 6 orang</p>
                        <p class="card-text">Unit tersedia: <span class="stok">5</span> kamar</p>
                        <div class="btn-group-custom">                            
                            <button class="btn btn-detail w-100 mb-2">Detail</button>
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="image-hover">
                        <img src="{{ asset('assets/Cabin3.1.jpg') }}" class="card-img-top img-first">
                        <img src="{{ asset('assets/Cabin3.2.jpg') }}" class="card-img-top img-second">
                    </div>

                    <div class="card-body">
                        <h5 class="card-title">Cabin View Lembah</h5>
                        <p class="card-text">Tipe: Valley View Cabin</p>
                        <p class="card-text">Harga: Rp. 1.290.000/Malam</p>
                        <p class="card-text">Kapasitas: 2 orang</p>
                        <p class="card-text">Unit tersedia: <span class="stok">5</span> kamar</p>
                        <div class="btn-group-custom">                            
                            <button class="btn btn-detail w-100 mb-2">Detail</button>
